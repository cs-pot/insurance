...
import com.cspot.insurahub.claim.enumeration.ClaimSortProperty;
...
class ClaimPageableInterceptor implements HandlerInterceptor {

    private static final List<String> ALLOWED_SORT_PROPERTIES = ClaimSortProperty.propertyNames();
